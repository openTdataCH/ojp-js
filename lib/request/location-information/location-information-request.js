...
export class LocationInformationRequest extends OJPBaseRequest {
    ...
    static initWithLocationName(stageConfig, locationName, restrictionTypes, limit = 10) {
    ...
    static initWithCircleLngLatRadius(stageConfig, circleLongitude, circleLatitude, circleRadius, restrictionTypes = [], numberOfResults = 1000) {
    ...
    static initWithBBOXAndType(stageConfig, bboxWest, bboxNorth, bboxEast, bboxSouth, restrictionTypes, limit = 1000, poiRestriction = null) {
