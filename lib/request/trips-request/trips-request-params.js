...
export class TripsRequestParams extends BaseRequestParams {
    constructor(fromTripLocation, toTripLocation, departureDate) {
        super();
    ...
    static initWithLocationsAndDate(fromLocation, toLocation, departureDate) {
    ...
    static initWithTripLocationsAndDate(fromTripLocationPoint, toTripLocationPoint, departureDate) {
        ...
        const tripRequestParams = new TripsRequestParams(fromTripLocationPoint, toTripLocationPoint, departureDate);
