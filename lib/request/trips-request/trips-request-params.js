...
export class TripsRequestParams extends BaseRequestParams {
    constructor(fromTripLocation, toTripLocation, departureDate = new Date(), tripRequestBoardingType = 'Dep', numberOfResultsType = 'NumberOfResults') {
        super();
    ...
    static Empty() {
        ...
        const requestParams = new TripsRequestParams(emptyTripLocationPoint, emptyTripLocationPoint, new Date(), 'Dep', 'NumberOfResults');
        return requestParams;
    }
    static initWithLocationsAndDate(fromLocation, toLocation, departureDate = new Date(), tripRequestBoardingType = 'Dep', numberOfResultsType = 'NumberOfResults') {
        ...
        const requestParams = TripsRequestParams.initWithTripLocationsAndDate(fromTripLocationPoint, toTripLocationPoint, departureDate, tripRequestBoardingType, numberOfResultsType);
        return requestParams;
    }
    static initWithTripLocationsAndDate(fromTripLocationPoint, toTripLocationPoint, departureDate = new Date(), tripRequestBoardingType = 'Dep', numberOfResultsType = 'NumberOfResults') {
        ...
        const tripRequestParams = new TripsRequestParams(fromTripLocationPoint, toTripLocationPoint, departureDate, tripRequestBoardingType, numberOfResultsType);
