...
export declare class TripRequest extends OJPBaseRequest {
    ...
    static initWithLocationsAndDate(stageConfig: StageConfig, fromLocation: Location, toLocation: Location, departureDate: Date, dateType?: TripDateType): TripRequest | null;
    static initWithTripLocationsAndDate(stageConfig: StageConfig, fromTripLocation: TripLocationPoint | null, toTripLocation: TripLocationPoint | null, departureDate: Date, dateType?: TripDateType): TripRequest | null;
