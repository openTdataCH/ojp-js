...
export class TripRequest extends OJPBaseRequest {
    ...
    static initWithLocationsAndDate(stageConfig, fromLocation, toLocation, departureDate, dateType) {
    ...
    static initWithTripLocationsAndDate(stageConfig, fromTripLocation, toTripLocation, departureDate, dateType) {
