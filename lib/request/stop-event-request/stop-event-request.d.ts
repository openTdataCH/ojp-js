...
export declare class StopEventRequest extends OJPBaseRequest {
    ...
    static initWithStopPlaceRef(stageConfig: StageConfig, language: Language, stopPlaceRef: string, stopEventType: StopEventType, stopEventDate: Date): StopEventRequest;
