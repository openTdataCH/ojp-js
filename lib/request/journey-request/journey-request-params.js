export class JourneyRequestParams {
    constructor(language, tripLocations, tripModeTypes, transportModes, departureDate, tripRequestBoardingType, numberOfResultsType) {
    ...
    static initWithLocationsAndDate(language, fromTripLocation, toTripLocation, viaTripLocations, tripModeTypes, transportModes, departureDate, tripRequestBoardingType, numberOfResultsType) {
        ...
        const requestParams = new JourneyRequestParams(language, tripLocations, tripModeTypes, transportModes, departureDate, tripRequestBoardingType, numberOfResultsType);
