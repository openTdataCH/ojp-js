...
export class JourneyRequest {
    ...
    computeTripResponse(journeyIDx, tripDepartureDate, callback) {
        ...
        const tripRequestParams = TripsRequestParams.initWithTripLocationsAndDate(this.requestParams.language, fromTripLocation, toTripLocation, tripDepartureDate, this.requestParams.tripRequestBoardingType);
